    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="https://cdn.poehali.dev/projects/78e14254-e69d-4aef-9cd4-6628ede29eb6/files/05205861-44bc-4b56-b368-d4a0dd910e35.jpg"
            alt="Фермер с продуктами"
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-5xl z-10 leading-tight">
        Семейный, мясной, молочный, овощной — выбери свежий набор от фермеров Чувашии. Средний чек 1500–3000 ₽.
      </p>
    </div>
  );
}